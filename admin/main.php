<?php
require '../config/koneksi.php'; session_start(); if(empty($_SESSION['id_admin'])){header('location:log.php');}
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <ul class="nav ace-nav">
          ...
          <li class="light-blue dropdown-modal user-min">
            ...
            <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
              ...
              <li>
                <a href="prosadmin/hanadmin.php?thisposition=<?php echo base64_encode('logoutadmin'); ?>">
        ...
        <ul class="nav nav-list">
          ...
          <li class="hover">
            <a href="main.php?thisaction=<?php echo base64_encode('kebutuhan') ?>">
              <i class="menu-icon fa fa-tachometer"></i>
              <span class="menu-text"> Data Pembelian </span>
            </a>
          ...
          <li class="hover">
            <a href="main.php?thisaction=<?php echo base64_encode('karyawan') ?>">
              <i class="menu-icon fa fa-tachometer"></i>
